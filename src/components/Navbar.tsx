...
import bg from '@/public/sekawan_bg.png'
...
const Navbar = () => {
    ...
    return (
        <div className=' mx-auto h-36 w-full px-[100px] shadow-md '>
            <nav className='flex bg-transparent p-6 items-center '>
                <div className='flex justify-center items-center'>
                    {/* <div className='w-12 h-12'>
                        <Image src={bg} alt={''} />
                        
                    </div>
                    <h1 className='font-bold text-xl'>Dekoor</h1>
                     */}
                ...
                >
                    <div className={` font-semibold items-center  ${isOpen ? '' : 'flex space-x-10'}`}>
                        <Link className='block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-black mr-4' href={'#home'}>
                        ...
                        <Link className='block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-black mr-4' href={'#wedTime'}>
                            <h1 className='text-lg font-semibold' > Partnerships</h1>
                        </Link>
                        <Link className='block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-black' href={'#home'}>
                ...
                <div className={` ml-20 gap-2 justify-center items-center  ${isOpen ? 'block' : ' hidden lg:flex'}`}>
                    <Link href={''}>
                        <Button className='bg-signUp py-3 px-6 h-12 text-customColor'>sign up</Button>
                    </Link>
